...
const items: MenuItem[] = [
  ...
  getItem('Work', '2', <FontAwesomeIcon icon={faTasks} />, [
    ...
    getItem('My Space', '4',<Link to={CustomRoutes.About.path}><FontAwesomeIcon icon={faProjectDiagram}/></Link>,[
      getItem('HAS BA', '5',<FontAwesomeIcon icon={faProjectDiagram}/>,[
        getItem('Công việc chung', '6',<FontAwesomeIcon icon={faProjectDiagram}/>),
        getItem('RPA Scheduler', '7',<FontAwesomeIcon icon={faProjectDiagram}/>)
      ],      
      ),
  ...
  getItem('Team', '10', <FontAwesomeIcon icon={faDollarSign} />, [getItem('Team 1', '6'), getItem('Team 2', '8')]),
